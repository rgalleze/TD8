...
int main(int argc, char *argv[]) {
    ...
    // On marque tout les nombres pairs à 0 et les nombres impairs à 1 
    for (size_t i = 0; i < NW; i++) {
        array[i] = 0xAAAAAAAAAAAAAAAA;
    }
    ...
    // On marque 2 comme étant  premier 
    array[0] |= 1 << 2;
